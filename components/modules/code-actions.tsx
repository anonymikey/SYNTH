...
import type { ModuleActionId } from "@/components/modules/types";
...
export function CodeActions({ filePath, statusMessage, onAction }: { filePath?: string; statusMessage?: string; onAction: (id: ModuleActionId, label: string) => void }) {
  return (
