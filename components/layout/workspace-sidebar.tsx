  ...
  return (
    <Sidebar collapsible="icon" className="border-sidebar-border bg-sidebar">
      <SidebarHeader className="h-16 border-b border-sidebar-border p-3">
        <div className="flex items-center justify-between gap-2"><SynthBrand showByline className="group-data-[collapsible=icon]:hidden" /><div className="hidden group-data-[collapsible=icon]:block"><SynthBrand compact /></div><SidebarTrigger className="text-muted-foreground hover:text-synth-cyan" /></div>
      </SidebarHeader>
